      ...
      <main className="container grid min-h-[calc(100vh-80px)] items-center gap-8 py-10 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <form className="card rounded-[26px] p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4">
            <label className="grid gap-2 text-sm font-extrabold">
              ...
              <span className="flex items-center gap-3 rounded-2xl border border-[#ece6ff] bg-white px-4 py-3">
                ...
                <input type="email" placeholder="vendor@example.com" className="w-full outline-none" />
              </span>
            </label>
            <label className="grid gap-2 text-sm font-extrabold">
              Password
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <Link href="/vendor/dashboard" className="block rounded-full bg-[#6C3CF0] px-6 py-4 text-center font-extrabold text-white shadow-lg shadow-purple-500/20 transition hover:bg-[#5b2fe0]">

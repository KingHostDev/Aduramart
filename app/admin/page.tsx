  ...
  return (
    <>
      ...
      <main className="container grid min-h-[calc(100vh-80px)] items-center gap-8 py-10 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <form className="card rounded-[26px] p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4">
            <label className="grid gap-2 text-sm font-extrabold">
              ...
              <span className="flex items-center gap-3 rounded-2xl border border-[#ece6ff] bg-white px-4 py-3">
                ...
                <input type="email" placeholder="admin@aduramart.com" className="w-full outline-none" />
              </span>
            </label>
            <label className="grid gap-2 text-sm font-extrabold">
              Password
          ...
          <Link href="/admin/dashboard" className="mt-6 block rounded-full border border-[#dcd1ff] bg-transparent px-6 py-4 text-center font-extrabold text-[#6C3CF0] transition hover:bg-[#F3EEFF]">
            Continue to admin
          </Link>
        </form>
      </main>
